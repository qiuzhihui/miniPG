...
var ImageUpload = function (_React$PureComponent) {
    _inherits(ImageUpload, _React$PureComponent);

    function ImageUpload(props) {
        _classCallCheck(this, ImageUpload);

        var _this2 = _possibleConstructorReturn(this, (ImageUpload.__proto__ || Object.getPrototypeOf(ImageUpload)).call(this, props));
            ...
            if (this.state.notAcceptedFileType.length > 0) {
                notAccepted = this.state.notAcceptedFileType.map(function (error, index) {
                    return React.createElement(
                        'div',
                        {
                            className: 'errorMessage' + _this3.props.errorClass,
                            key: index,
                            style: _this3.props.errorStyle
                        },
                        '* ',
                        error,
                        ' ',
