...
def show_car_page():
    ...
    if request.method == "GET":
        print(request.args)
        result = controller.get_car(car_type="used_car")
...
def test():
     if request.method == "POST":
        ...
        made_year = data["madeYear"]
        price = data["price"]
        kbb_price = data["kbbPrice"]
        name = data["name"]
        millage = data["millage"]
        brand = data["brand"]
        fuel_type = data["fuelType"]
        mpg_local = data["localMPG"]
        mpg_highway = data["highwayMPG"]
        interior_color = data["interiorColor"]
        outside_color = data["outsideColor"]
        manual_auto = data["autoManual"]
        description = data["description"]
        data = {"car_type": "used_car", "made_year": made_year, "name": name, "brand": brand,
